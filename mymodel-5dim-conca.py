...
train_steps = 89984 // dp.batch_size
val_steps = (100480 - 89985 -dp.lookback) // dp.batch_size
...
def create_cnn():
    ...
    model.add(TimeDistributed(BatchNormalization()))
    model.add(TimeDistributed(Activation('relu')))
    model.add(layers.Bidirectional(layers.GRU(128, dropout=0.3)))
...
filepath='CNNRNNMODEL_CONCA.hdf5'
...
model.save("my_h5_model_CONCA.h5")
'''
