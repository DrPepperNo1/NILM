...
dp = package_dataprocess.Nilm_classes.Nilm_dataprocess(path_csv=r"DATA/UKData_by_hour/week1/vicurve_name.xlsx",path_img=r"DATA/UKData_by_hour/week1/vicurve32x32/")
